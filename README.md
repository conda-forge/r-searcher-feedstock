...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-searcher-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10813&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-searcher-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-searcher` can be installed with:

```
conda install r-searcher
```

It is possible to list all of the versions of `r-searcher` available on your platform with:
